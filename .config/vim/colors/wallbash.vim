...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['21252B', '658FA3', '7A97C2', '7AA3C2', 
                                \ '6584A3', '9AC5E6', '9AB8E6', 'FFFFFF',
                                \ '38526C', '7AAAC2', '9AB8E6', 'AAD2F0', 
                                \ '7A9EC2', 'AAD2F0', 'AAC6F0', 'FFFFFF']
  else
    " Lighter colors for light theme
    let g:terminal_ansi_colors = ['FFFFFF', '9ACCE6', 'AAC6F0', 'AAD2F0', 
                                \ '9AC0E6', 'CCE9FF', 'CCE0FF', '547A97',
                                \ 'FFFFFF', 'AAD9F0', 'CCE0FF', 'CCE9FF', 
                                \ 'AACDF0', 'CCE9FF', 'CCE0FF', '21252B']
  endif
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#547A97 guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#547A97 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#FFFFFF guibg=#38526C gui=NONE cterm=NONE
  ...
  hi NeoTreeWinSeparator guifg=#38526C guibg=NONE gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#FFFFFF guibg=#547A97 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#21252B guibg=#CCE0FF gui=bold cterm=bold
  hi TabLineSeparator guifg=#657EA3 guibg=#547A97 gui=NONE cterm=NONE
  
  " Interactive elements with dynamic contrast
  hi Search guifg=#38526C guibg=#AAC6F0 gui=NONE cterm=NONE
  hi Visual guifg=#38526C guibg=#9AB8E6 gui=NONE cterm=NONE
  hi MatchParen guifg=#38526C guibg=#CCE0FF gui=bold cterm=bold
  ...
  hi WhichKeyFloat guibg=#38526C guifg=NONE gui=NONE cterm=NONE
  
  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#547A97 gui=NONE cterm=NONE
  hi Cursor guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  hi TermCursor guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  ...
  hi QuickFixLine guifg=#38526C guibg=#9AB8E6 gui=NONE cterm=NONE
  hi IncSearch guifg=#38526C guibg=#CCE0FF gui=NONE cterm=NONE
  hi NormalNC guibg=#38526C guifg=#FFFFFF gui=NONE cterm=NONE
  hi Directory guifg=#AAC6F0 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#38526C guibg=#CCE0FF gui=bold cterm=bold
  
  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#CCE0FF guibg=#38526C gui=NONE cterm=NONE
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#547A97 gui=italic cterm=italic
  ...
  hi NeoTreeGitDeleted guifg=#658FA3 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7AA3C2 guibg=NONE gui=NONE cterm=NONE
  ...
  " hi NeoTreeCursorLine guibg=#9AB8E6 guifg=#21252B gui=bold cterm=bold
  ...
  hi WinBar guifg=#FFFFFF guibg=#547A97 gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#38526C gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#CCE0FF guifg=#21252B gui=bold cterm=bold
  hi BufferTabpageFill guibg=#21252B guifg=#FFFFFF gui=NONE cterm=NONE
  ...
  hi BufferCurrentSign guifg=#CCE0FF guibg=#38526C gui=NONE cterm=NONE
  hi BufferVisible guifg=#FFFFFF guibg=#547A97 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#547A97 gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#9AB8E6 guibg=#38526C gui=NONE cterm=NONE
  hi BufferInactive guifg=#FFFFFF guibg=#38526C gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#657EA3 guibg=#38526C gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#657EA3 guibg=#38526C gui=NONE cterm=NONE
  ...
  hi Normal guibg=NONE guifg=#21252B gui=NONE cterm=NONE
  hi Pmenu guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#4B677D gui=NONE cterm=NONE
  hi StatusLineNC guifg=#21252B guibg=#FFFFFF gui=NONE cterm=NONE
  hi VertSplit guifg=#4B677D guibg=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#4B677D guibg=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#38526C guibg=NONE gui=NONE cterm=NONE
  
  " NeoTree with transparent background including unfocused state
  hi NeoTreeNormal guibg=NONE guifg=#21252B gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#21252B gui=NONE cterm=NONE
  hi NeoTreeFloatNormal guibg=NONE guifg=#21252B gui=NONE cterm=NONE
  ...
  " TabLine highlighting with complementary accents
  hi TabLine guifg=#21252B guibg=#FFFFFF gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#FFFFFF guibg=#293D52 gui=bold cterm=bold
  hi TabLineSeparator guifg=#4B677D guibg=#FFFFFF gui=NONE cterm=NONE
  
  " Interactive elements with complementary contrast
  hi Search guifg=#FFFFFF guibg=#3A526B gui=NONE cterm=NONE
  hi Visual guifg=#FFFFFF guibg=#4B677D gui=NONE cterm=NONE
  ...
  hi CmpItemMenu guifg=#38526C guibg=NONE gui=italic cterm=italic
  hi CmpItemAbbr guifg=#21252B guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#547A97 guibg=NONE gui=strikethrough cterm=strikethrough
  
  " Specific menu highlight groups
  hi WhichKey guifg=#293D52 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeperator guifg=#547A97 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Cursor guibg=#21252B guifg=#FFFFFF gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  hi TermCursor guibg=#21252B guifg=#FFFFFF gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#21252B gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  ...
  hi NormalNC guibg=#FFFFFF guifg=#38526C gui=NONE cterm=NONE
  ...
  hi FoldColumn guifg=#38526C guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#21252B guibg=#FFFFFF gui=italic cterm=italic

  " File explorer specific highlights
  hi NeoTreeNormal guibg=NONE guifg=#21252B gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#21252B gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#293D52 guibg=NONE gui=bold cterm=bold
  hi NeoTreeFileName guifg=#21252B guibg=NONE gui=NONE cterm=NONE
  ...
  hi NeoTreeGitAdded guifg=#57778F guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitDeleted guifg=#658FA3 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7AA3C2 guibg=NONE gui=NONE cterm=NONE
  ...
  hi WinBar guifg=#21252B guibg=#FFFFFF gui=bold cterm=bold
  hi WinBarNC guifg=#38526C guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#293D52 guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#547A97 gui=NONE cterm=NONE
  ...
  hi BufferVisible guifg=#21252B guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#38526C guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#4B647D guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactive guifg=#547A97 guibg=#FFFFFF gui=NONE cterm=NONE
...
hi FloatBorder guifg=#4B677D guibg=NONE gui=NONE cterm=NONE
hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#FFFFFF guibg=#7A97C2 gui=NONE cterm=NONE
hi DiffChange guifg=#FFFFFF guibg=#6588A3 gui=NONE cterm=NONE
hi DiffDelete guifg=#FFFFFF guibg=#658FA3 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE

" Fix selection highlighting with proper color derivatives
hi TelescopeSelection guibg=#CCE9FF guifg=#21252B gui=bold cterm=bold
hi TelescopeSelectionCaret guifg=#FFFFFF guibg=#CCE9FF gui=bold cterm=bold
hi TelescopeMultiSelection guibg=#9AC5E6 guifg=#21252B gui=bold cterm=bold
hi TelescopeMatching guifg=#7AAAC2 guibg=NONE gui=bold cterm=bold

" Minimal fix for explorer selection highlighting
hi NeoTreeCursorLine guibg=#CCE9FF guifg=#21252B gui=bold

" Fix for LazyVim menu selection highlighting
hi Visual guibg=#CCEEFF guifg=#21252B gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#CCEEFF guifg=#21252B gui=bold
hi WildMenu guibg=#CCEEFF guifg=#21252B gui=bold
...
augroup FixNeoTreeBackground
  ...
  autocmd ColorScheme,VimEnter * if &background == 'dark' |
    \ hi NeoTreeCursorLine guibg=#CCE9FF guifg=#21252B gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#CCE9FF guifg=#21252B gui=bold cterm=bold |
    \ else |
